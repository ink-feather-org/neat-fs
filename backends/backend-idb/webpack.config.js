...
module.exports = {
  ...
  output: {
    ...
    filename: 'feather-ink-neat-fs-idb-backend.js',
    library: 'feather-ink-neat-fs-idb-backend',
    libraryTarget: 'umd',
    globalObject: 'this',
    clean: true,
  },
  externals: {
    ...
    '@ink-feather-org/idb-mutex': {
      commonjs: '@ink-feather-org/idb-mutex',
      commonjs2: '@ink-feather-org/idb-mutex',
      amd: '@ink-feather-org/idb-mutex',
      root: '@ink-feather-org/idb-mutex',
    },
  },
  optimization: {
    minimize: true,
